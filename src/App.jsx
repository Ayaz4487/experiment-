          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {orderHistory.length > 0 && (
                <span className="absolute top-1 right-1 bg-neutral-600 text-white text-xs font-bold w-6 h-6 flex items-center justify-center rounded-full border-2 border-neutral-900 shadow-md">
                  {orderHistory.length}
                </span>
              )}
            </button>
